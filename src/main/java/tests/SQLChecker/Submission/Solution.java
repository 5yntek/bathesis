...
import tests.SQLChecker.DBFit.CustomMySQLTest;
import tests.SQLChecker.DBFit.ResultStorage;
...
public class Solution {
    ...
    public Count runDBFitTest(DataSource source, SQLScript resetScript, Parse p) throws SQLException {
    ...
    public String getParseResult(Parse parse) {
